 ...
 *
 * Call evaluate() with an index from lib/search-index.js. That module needs
 * Next's aliases and generated content, so this runs from somewhere that has
 * them rather than from bare node.
 */
