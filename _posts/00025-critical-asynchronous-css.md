...
image:
  ...
  medium: false
  thumbnail: false
excerpt: "I’ve spent the best part of my free time for the most recent months, working on a website which I recently completed. This will be the first in a series of posts detailing some of the problems I encountered over the course of making the website. Starting with how I setup critical and asynchronous CSS to be a maintainable part of my workflow."
meta:
  description: "The method I use for keeping my critical path CSS maintainable and how to load your CSS asynchronously for fast websites."
design:
  background: "#e9f5f5"
categories: "Code"
date: "2015-01-06T08:00:00+00:00"
updated: "2016-08-28T12:54:52+00:00"
author:
  name: "Steve"
  picture: "[replace-me]"
ogImage:
