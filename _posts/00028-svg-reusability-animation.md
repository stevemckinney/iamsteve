...
image:
  ...
  medium: false
  thumbnail: false
excerpt: "The great thing about SVG is CSS can modify it. Which allows you to modify the way paths look quite drastically. This is really handy for saving on page weight because you don’t have to load multiple images and it looks like it was meant to happen."
meta:
  description: "How to animate and change fill colours on inline SVG. Using currentcolor and groups we can animate and manipulate SVG unlike any other image type."
design:
  background: "#e9f5f5"
categories: "Code"
date: "2015-01-27T08:00:00+00:00"
updated: "2016-08-28T12:54:11+00:00"
author:
  name: "Steve"
  picture: "[replace-me]"
ogImage:
