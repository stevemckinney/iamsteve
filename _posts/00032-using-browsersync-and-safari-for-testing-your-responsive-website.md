...
image:
  ...
  medium: false
  thumbnail: false
excerpt: "Testing a responsive design on an actual device can be quite annoying when you’re down to the point of refining the design and making it more appropriate to such a small screen. As it’s usually testing and refining the best you can locally, then checking on the device through whatever means you usually do it."
meta:
  description: "How to use BrowserSync to make testing on devices easy. I cover how to use it with iOS devices, Xcode and Safari."
design:
  background: "#e9f5f5"
categories: "Code"
date: "2015-02-17T08:00:00+00:00"
updated: "2021-06-11T06:59:56+00:00"
author:
  name: "Steve"
  picture: "[replace-me]"
ogImage:
...
<figure markdown="1">
![]({filedir_3}Screenshot_2015-02-02_08.21.21.png)
...
<figure markdown="1">
![]({filedir_3}Screenshot_2015-02-02_10.00.47.png)
