...
"
meta:
  description: "The method I use for getting my final SVG's from any situation. I provide a method on how to bring your paths into Illustrator from Photoshop and then export."
design:
  background: "#e9f5f5"
categories: "Design"
date: "2013-09-04T18:44:00+00:00"
updated: "2016-08-28T12:58:22+00:00"
author:
  name: "Steve"
  picture: "[replace-me]"
ogImage:
...
status: "open"
slug: "my-svg-workflow-from-awkward-to-simple"
---
...
![Exporting paths in photoshop to illustrator](https://iamsteve.test/uploads/blog/export_paths.png)
...
![The artboard is round the icon](https://iamsteve.test/uploads/blog/svg_artboard.png)

3. Go to file and save, name your file, choose svg as the format and check 'Use Artboards' like this

![Saving an SVG, format SVG, artboards checked](https://iamsteve.test/uploads/blog/svg_save.png)
