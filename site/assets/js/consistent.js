...
sethrefs();
/* http://prismjs.com/download.html?themes=prism&languages=markup+css+clike+javascript+bash+css-extras+markdown+php+php-extras+scss&plugins=line-numbers */
...
function getshots(name, count, el) {
  ...
  var html = [], i = 0;
  var token = 'b6d37f29cd508fad523691722fbbdbfba0b570cdf73c8aa5605fbdd1d52aa8d2';
  
  $.ajax({
    type: 'GET',
    url: 'https://api.dribbble.com/v1/users/' + opt.player + '/shots',
    ...
    success: function(response) {
      ...
      $.each(response, function (i, shot) {
        ...
        html += '<img src="' + shot.images.normal + '" alt="' + shot.title + '">';
        html += '<a href="' + shot.html_url + '" title="View ' + shot.title + ' on Dribbble">';
        html += '<figcaption>';
