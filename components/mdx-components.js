...
const postComponents = {
  ...
  h3: (props) => <h3 {...props} className="font-variation-semibold" />,
  h4: (props) => <h4 {...props} className="font-variation-semibold" />,
  h5: (props) => <h5 {...props} className="font-variation-semibold" />,
  h6: (props) => <h6 {...props} className="font-variation-semibold" />,
  p: (props) => <p {...props} />,
