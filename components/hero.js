...
export default function Hero() {
  return (
    <div
      className={`${styles.hero} max-lg:grid max-lg:grid-cols-subgrid col-container place-items-center flex flex-col items-center relative frame frame-16 lg:frame-40 md:frame-outset-top py-12 lg:pt-10 lg:pb-[5.5rem] gap-y-4 max-lg:px-4`}
    >
