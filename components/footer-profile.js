...
export default function FooterProfile() {
  return (
    <aside className="grid grid-flow-dense grid-cols-2 sm:grid-cols-[repeat(16,_minmax(min-content,_1fr))] grid-rows-[repeat(auto-fill,_minmax(min-content,1fr))] gap-2 col-start-container-start col-end-container-end">
      <Subscribe className="col-span-full lg:col-span-8 xl:col-span-7 row-span-6 rounded-lg lg:rounded-xl bg-white shadow-placed py-12 px-8 sm:px-12 sm:py-12 md:px-[10vmax] xl:px-[4.5rem]" />
      ...
      <div className="col-span-1 sm:col-span-8 lg:col-span-5 xl:col-span-5 row-span-2 rounded-lg lg:rounded-xl bg-white shadow-placed py-12 px-8 sm:px-12 sm:py-12 xl:px-[4.5rem] flex flex-col justify-end">
