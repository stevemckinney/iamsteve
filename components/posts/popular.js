...
export default function PopularPosts({ posts, title, linkText, linkHref, accentColor }) {
  return (
    <>
      <Title link={linkHref} text={linkText} ariaID={`popular-${title.toLowerCase()}`} className="sm:px-4 md:px-8 sm:-mx-4 md:-mx-8 sm:bg-neutral-01-150 sm:bg-[url(/images/texture.png)] sm:bg-[172px_auto] sm:bg-blend-multiply sm:-mt-[1.125rem] md:-mt-[1.375rem]">
