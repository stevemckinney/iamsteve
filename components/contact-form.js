...
const ContactForm = () => (
  <Form.Root className="w-full grid grid-cols-5 gap-8" data-netlify="true">
    ...
    <Form.Submit asChild>
      <button className="button-dandelion select-none self-start min-w-fit font-ui text-base/snug lowercase text-dandelion-800 text-center bg-dandelion-300 active:bg-dandelion-400 rounded-sm transition duration-200 shadow-dandelion-placed hover:shadow-dandelion-picked active:shadow-reduced px-8 py-3 flex-auto [--ui-border-color:theme(colors.dandelion.600)] [--ui-border-color-hover:theme(colors.dandelion.700)]">
        Send
      </button>
    </Form.Submit>
  </Form.Root>
