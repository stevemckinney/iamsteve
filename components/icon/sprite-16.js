  ...
  >
    <defs>
      ...
      <svg id="type-16" viewBox="0 0 16 16">
        <g className="type">
          <path d="M3 3h10" className="fill-none stroke-current stroke-2 sl-r"/>
          ...
          <path d="M13 6V3" className="fill-none stroke-current stroke-2 sl-r"/>
          <path d="M6 13h4" className="fill-none stroke-current stroke-2 sl-s"/>
        </g>
      </svg>
