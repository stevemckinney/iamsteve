...
const NotepadHeader = ({ children }) => {
  return (
    <div className="px-10 pt-[1.75rem] pb-[1.625rem] bg-dandelion-300 shadow-dandelion-placed [--ui-border-color:var(--color-dandelion-600)] [--ui-border-color-strong:var(--color-dandelion-700)] rounded-tl-lg rounded-tr-lg relative z-20">
