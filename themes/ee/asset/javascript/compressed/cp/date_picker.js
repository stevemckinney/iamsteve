...
// Suffix
suffix=1==r?"st":2==r?"nd":3==r?"rd":"th",
// Calculate day of year
diff=e-new Date(e.getFullYear(),0,0),doy=Math.ceil(diff/864e5)-1,
// Calculate days in this month
days_in_month=2==n?1==new Date(a,1,29).getMonth()?29:28:[4,6,9,11].indexOf(n)>-1?30:31;var c={
// Day
...
$(i.element).data("dateFormat")&&(n=$(i.element).data("dateFormat")),$(i.element).val(EE.cp.datePicker.get_formatted_date(t,n)),$(i.element).data("timestamp",EE.cp.datePicker.get_formatted_date(t,"%U")),$(i.element).focus(),$(".date-picker-wrap").toggle(),e.preventDefault(),e.stopPropagation()}),
// Prevent manual scrolling of the huge inner clip div
$(".date-picker-clip-inner").on("mousewheel",function(e){e.preventDefault()})}if($(this.element).val()){var l=$(this.element).data("timestamp");t=new Date(l?1e3*l:Date.parse($(this.element).val())),a=t.getUTCDate(),n=t.getUTCFullYear(),r=t.getUTCMonth()}else t=new Date,n=t.getFullYear(),r=t.getMonth();var c=this.generate(n,r);null!=c&&($(".date-picker-clip-inner").html(c),a&&$(".date-picker-item td:contains("+a+")").each(function(){$(this).text()==a&&$(this).addClass("act")}))},generate:function(e,t){if(
// Set variables
this.month=t,this.year=e,this.calendars.indexOf(e+"-"+t)>-1)return null;var a=EE.cp.datePicker.Month.total_days(e,t),n=(EE.cp.datePicker.Month.total_days(e,t-1),EE.cp.datePicker.Month.first_day(e,t)),r=7-(n+a)%7,i=new Date,d=t-1>-1?t-1:11,l=12>t+1?t+1:0;r=7==r?0:r;
// Leading dimmed
