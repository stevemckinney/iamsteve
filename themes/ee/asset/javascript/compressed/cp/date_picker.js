...
// showing
year:2010,month:0,init:function(e){var t,a=null,n=null,i=null;this.element=e,this.calendars=[];var r=this;if(0==$(".date-picker-wrap").length){var d=$("body");$("#cform").length&&(d=$("#cform")),d.append('<div class="date-picker-wrap"><div class="date-picker-clip"><div class="date-picker-clip-inner"></div></div></div>'),
...
$(r.element).data("dateFormat")&&(n=$(r.element).data("dateFormat")),$(r.element).val(EE.cp.datePicker.get_formatted_date(t,n)),$(r.element).data("timestamp",EE.cp.datePicker.get_formatted_date(t,"%U")),$(r.element).focus(),$(".date-picker-wrap").toggle(),e.preventDefault(),e.stopPropagation()}),
