...
_bindForms:function(e){var i=this;e.has(".form-ctrls .btn").each(function(e,s){var n=t(this);n.find(".form-ctrls input.btn");i.bindInputs(n),i._dismissSuccessAlert(n)})},/**
	 ...
	 */
_dismissSuccessAlert:function(e){t("input, select, textarea",e).change(function(t){var i=e.find("div.alert.success");i.size()>0&&i.remove()})},/**
...
_errorsExist:function(e){return 0!=t("fieldset.invalid, td.invalid",e).size()},/**
	 ...
	 */
_sendAjaxRequest:function(e){if(!this.paused){var i=e.parents("form");
...
if(!i.hasClass("ajax-validate"))return void this._toggleErrorForFields(i,e,"success");var s=this,n=i.attr("action"),a=i.serialize();t.ajax({url:n,data:a+"&ee_fv_field="+e.attr("name"),type:"POST",dataType:"json",success:function(t){s._toggleErrorForFields(i,e,t)}})}},/**
	 ...
	 */
_toggleErrorForFields:function(e,i,s){var n=i.parents("div[class*=setting]").not("div[class=setting-note]"),a=n.parents("fieldset").size()>0?n.parents("fieldset"):n.parent(),r="em.ee-form-error-message",o=!1,d=i.parents(".tab"),u=d.size()>0?d.attr("class").match(/t-\d+/):"",// Grabs the tab identifier (ex: t-2)
l=t(d).parents(".tab-wrap").find('a[rel="'+u+'"]'),// Tab link
...
a.hasClass("grid-publish")&&(a=a.find("div.setting-txt"),n=i.parents("td"),o=!0),"success"==s)
...
l.size()>0&&!this._errorsExist(d)&&l.removeClass("invalid"),
// Re-enable submit button only if all errors are gone
(!this._errorsExist(e)||!this._errorsExist(d)&&c)&&(f.removeClass("disable").removeAttr("disabled"),f.each(function(e,i){i=t(i),i.is("input")?i.attr("value",i.data("submit-text")):i.is("button")&&i.text(i.data("submit-text"))}));else{
