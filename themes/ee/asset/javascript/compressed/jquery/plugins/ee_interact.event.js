...
t.event.add(this,"change.specialInteract",function(){t.event.trigger("interact",c.data,this)})}else n[this]=c,t.event.add(this,"keyup.specialInteract change.specialInteract input.specialInteract cut.specialInteract paste.specialInteract",function(e){t(this).find(n[this].selector).has(e.target)&&(a(e.target)?(t.data(this,"_interact_cache",this.value),t.inArray(e.type,["input","cut","paste"])?i(e.target,n[this].data,25):i(e.target,n[this].data)):t.event.trigger("interact",n[this].data,e.target))})},remove:function(e){delete n[this],t(this).unbind(".specialInteract")}}}(jQuery);