...
for("boolean"!=typeof l&&(l=!1),""!==s&&"title"===e(this).attr("id")&&u.substr(0,s.length)===s&&(u=u.substr(s.length)),u=E+u,u=u.toLowerCase().replace(c,i),t=0;t<u.length;t++)a=u.charCodeAt(t),a>=32&&128>a?g+=u.charAt(t):a in p&&(g+=p[a]);u=g,u=u.replace(/<(.*?)>/g,""),u=u.replace(/&[a-zA-Z]+;/g,""),u=u.replace(/\[\/?(b|i|u|del|em|ins|strong|pre|code|abbr|span|sup|sub|color|size|strike|url|email|style)\b=?.*?\]/g,""),u=u.replace(/\s+/g,i),u=u.replace(/\//g,i),u=u.replace(/[^a-z0-9\-\._]/g,""),u=u.replace(/\+/g,i),u=u.replace(n,i),u=u.replace(/^[\-\_]|[\-\_]$/g,""),u=u.replace(/\.+$/g,""),l&&(u=u.replace(/\./g,"")),r&&e(r).val(u.substring(0,75))})}}(jQuery);