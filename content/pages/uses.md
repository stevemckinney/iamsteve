...
<section className="col-content max-w-prose">
  ...
  <dl className="f4">
    ...
    <dt className="text-heading mb-1 text-lg">[Affinity Photo](https://affinity.serif.com/en-gb/photo/)</dt>
    ...
    <dt className="text-heading mb-1 text-lg">[CleanshotX](https://cleanshot.com)</dt>
    <dd className="text-ui-body mb-3 text-lg">Not only a nice screenshot tool, but can record videos, create gifs, etc.</dd>
    <dt className="text-heading mb-1 text-lg">[PixelSnap](https://getpixelsnap.com)</dt>
...
<section className="col-content max-w-prose">
  ...
  <dl className="f4">
    <dt className="text-heading mb-1 text-lg">[Roc Grotesk (variable)](https://fonts.adobe.com/fonts/roc-grotesk-variable)</dt>
    <dd className="text-ui-body mb-3 text-lg">I use Roc Grotesk for headings.</dd>
    <dt className="text-heading mb-1 text-lg">[Elza](https://fonts.adobe.com/fonts/elza)</dt>
    <dd className="text-ui-body mb-3 text-lg">I use Elza for body copy.</dd>
    <dt className="text-heading mb-1 text-lg">[Covik Sans Mono](https://fonts.adobe.com/fonts/covik-sans-mono)</dt>
    <dd className="text-ui-body mb-3 text-lg">I use Covik Sans Mono for code.</dd>
    <dt className="text-heading mb-1 text-lg">[Next.js](https://nextjs.org)</dt>
    ...
    <dt className="text-heading mb-1 text-lg">[Vercel](https://vercel.com)</dt>
    <dd className="text-ui-body mb-0 text-lg">One of the main reasons I switched to Next.js is to take advantage of
      hosts like Vercel. It’s taken a lot of the hassle out of deployments and managing a site, working on and testing different branches, etc.</dd>
  </dl>
</section>
