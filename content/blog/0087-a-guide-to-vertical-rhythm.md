...
summary: ‘Vertical rhythm is a typographic practice that creates harmony between text and images. This post focuses on the why rather than the how, to build a better understanding.’
...
<CodePen slug="QjWowq" title="Vertical rhythm example" height={480} themeId="13022" />
...
```html
image width / image height = aspect ratio content-width / aspect ratio = image
height
```
