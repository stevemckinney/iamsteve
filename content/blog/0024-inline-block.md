...
Another benefit to using this method is alignment tends to come without the issues of floating. You can easily align an element elements to the right or centre by using the relevant `text-align` value. _However, this has to be applied to the parent_, so our markup and CSS would look like the following:

```html showLineNumbers
<div class="“parent”">
  <div class="“inline-block-element”">Some content here</div>
</div>
```
...
<div class="grid grid-with-gutter">
  <div class="grid-cell grid-6 grid-medium-4">Content</div>
  <div class="grid-cell grid-6 grid-medium-4">Content</div>
  <div class="grid-cell grid-6 grid-medium-4">Content</div>
  <div class="grid-cell grid-6 grid-medium-4">Content</div>
</div>
