...
summary: "Setting a cookie for critical path CSS in WordPress requires more care than a simple setcookie call. This covers the PHP approach and how to use it in your theme."
