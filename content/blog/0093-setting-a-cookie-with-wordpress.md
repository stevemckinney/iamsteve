...
summary: "Setting a cookie in Wordpress the right way — using a PHP action rather than setcookie() in header.php. Useful for caching critical CSS after the first visit."
