...
summary: ‘Grunticon V2 introduced inline SVG with automatic fallbacks for older browsers. This covers how to use it via a grunt task, with the added benefit of CSS-modifiable SVG.’
