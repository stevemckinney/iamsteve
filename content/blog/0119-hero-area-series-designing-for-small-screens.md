...
summary: "Part two of the hero area series — adapting the desktop design for mobile screens. Only mobile-sized resolutions are covered, with tablet needing only minor adjustments."
...
<div className="article-image flex center">
  <Image src="/images/blog/ch-final-small.png" width={640} height={568} alt="Completed small screen hero area design" />
</div>
...
<div className="article-image flex center">
  <Image src="/images/blog/ch-sketches.jpg" width={640} height={710} alt="Pencil sketches of small screen hero area layout ideas" />
</div>
...
<div className="article-image flex center">
  <Image src="/images/blog/ch-new-layer-rename-lock.gif" unoptimized={true} width={640} height={320} alt="Creating a new layer, renaming and locking it in Illustrator" />
</div>
...
### Where you should be
<div className="article-image flex center">
  <Image src="/images/blog/ch-without-image.png" width={640} height={568} alt="Small screen layout with title, description and button before adding the image" />
</div>
...
<div className="article-image flex center">
  <Image src="/images/blog/ch-add-symbol.png" width={640} height={420} alt="Dragging the image into the Illustrator symbols panel" />
</div>
...
### Adding the symbol
<div className="article-image flex center">
  <Image src="/images/blog/ch-symbol-panel.png" width={640} height={420} alt="The symbol in the Illustrator symbols panel ready to use" />
</div>
...
<div className="article-image flex center">
  <Image src="/images/blog/ch-rough-position.png" width={640} height={420} alt="Image roughly positioned on the small screen artboard" />
</div>
...
<div className="article-image flex center">
  <Image src="/images/blog/ch-everything-selected.png" width={640} height={420} alt="All layers selected on the artboard ready to create a mask" />
</div>
...
<div className="article-image flex center">
  <Image src="/images/blog/ch-final-small.png" width={640} height={568} alt="Final small screen hero area design with masked image" />
</div>
