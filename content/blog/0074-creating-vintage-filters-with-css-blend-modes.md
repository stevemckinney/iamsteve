...
summary: 'Using CSS mix-blend-mode to apply vintage-style photo filters, much like you would in Photoshop. Includes a live demo to test the different filter options.'
...
<CodePen slug="gpaXeB" title="Vintage blend mode creator" height={552} themeId="13022" />
