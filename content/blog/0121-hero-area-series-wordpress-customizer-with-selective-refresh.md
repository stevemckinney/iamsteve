...
summary: "Making the hero area editable in Wordpress using the Customizer API with selective refresh. The final post in the series, adding a smooth live editing experience."
