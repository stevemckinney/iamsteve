...
summary: 'The Illustrator keyboard shortcuts worth memorising. Not exhaustive, but the ones that save you from constantly clicking through panels and menus.'
...
_This is common to all applications_. Forget which menu ‘Offset Path’ is in? No problem, this shortcut reveals the menu search. Use the arrow keys to navigate then press enter and you don’t have to leave the keyboard.
