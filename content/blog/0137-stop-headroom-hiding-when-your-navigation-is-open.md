...
summary: "When using headroom.js, the fixed header can hide even when the navigation is open. This post shows how to prevent that using headroom's callbacks."
