...
summary: "An introduction to CSS shapes level one — polygon, circle, inset and ellipse. Covers use cases, strengths, and how to wrap text around shapes using shape-outside."
