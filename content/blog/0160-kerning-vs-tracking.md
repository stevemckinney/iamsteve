---
title: 'Kerning vs tracking: what they are and how to use them'
date: '2017-03-07T13:25:00+00:00'
lastmod: '2019-10-04T07:28:23+00:00'
summary: 'Understand the differences between kerning and tracking, along with how and when to use them.'
metadesc: 'Kerning adjusts space between two letters, tracking adjusts all letters at once. Learn the difference, when to use each, and how to apply them in Illustrator and CSS.'
theme: '#fff3f0'
tags: ['Design']
...
<div className="article-image">
  <Image src="/images/blog/kerning-tracking-kerning-word@2x.png" width={738} height={492} alt="The word kerning with guides showing the space between each letter" />
</div>
...
It’s not always perfect and it’s generally make or break for having a well-designed logo. You also have to consider the usage intentions of the typeface, as it may be more suited smaller or larger sizes. So while there is nothing stopping you from using a particular font how you wish, you will likely find undesirable spacing between letters.

<div className="article-image">
  <Image src="/images/blog/kerning-tracking-with-without-kerning@2x.png" width={738} height={492} alt="Comparing text with and without manual kerning applied" />
</div>
...
<figure>
<Image src="/images/blog/kerning-tracking-with-tracking-kerning@2x.png" width={738} height={492} alt="Comparing the same text with tracking applied versus kerning applied" />
...
<div className="article-image">
  <Image src="/images/blog/kerning-tracking-kerning.gif" unoptimized={true} width={738} height={480} alt="Kerning letters in Illustrator using the arrow keys" />
</div>
...
<div className="article-image">
  <Image src="/images/blog/kerning-tracking-kerning@2x.png" width={738} height={492} alt="The kerning field in the Illustrator character panel" />
</div>
...
You can also use this dropdown to apply different types of kerning. For example, ‘optical’ applying this across the whole type should make the overall kerning better.

## How to distribute kerning space

The techniques to master kerning take some time. As I mentioned earlier it’s making the space feel equal between all letters and natural. While it’s inefficient to kern whole blocks of text, doing so for logos and smaller type compositions can improve legibility as well as overall quality.
...
<div className="article-image">
  <Image src="/images/blog/kerning-tracking-under-capitals@2x.png" width={738} height={492} alt="Nudging a lowercase letter under the overhang of an uppercase T" />
</div>

This may seem to go against the true bounds of the letterform, however, in the world of type, optical alignment nine times out of ten is better.
...
<figure>
<Image src="/images/blog/kerning-tracking-ligatures@2x.png" width={738} height={492} alt="Ligature examples showing ffl, fi and Th in regular and ligature forms" />
...
<div className="article-image">
  <Image src="/images/blog/kerning-tracking-tracking@2x.png" width={738} height={492} alt="The tracking field in the Illustrator character panel" />
</div>
...
<figure>
<Image src="/images/blog/kerning-tracking-tracking-titles@2x.png" width={738} height={492} alt="A heading with decreased tracking compared to the default" />
...
<figure>
<Image src="/images/blog/kerning-tracking-tracking-titles-2@2x.png" width={738} height={492} alt="Small caps text with increased tracking for readability" />
...
When you have complete control over the content. Kerning only makes sense in places you can apply it quickly. It’s not possible to apply on a large scale.

A logo is the main use case, but you may have a one off image that you want to typeset and have ideal kerning. If you’re applying it to your own website, tracking (letter-spacing in CSS) is the better option. It’s highly inefficient and impractical to maintain kerning at that scale.
