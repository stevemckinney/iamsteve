...
<div class="article-image">
  <img src="/images/blog/ch-export-artboard-select.png" width="780" height="328" />
</div>
...
<div class="article-image">
  <img src="/images/blog/ch-export-settings.png" width="640" height="360" />
</div>
...
```html
<link
  href="https://fonts.googleapis.com/css?family=Raleway:900,800,700|Merriweather"
  rel="stylesheet"
/>
```
...
<html lang="en">
  <head>
    ...
    <link
      href="https://fonts.googleapis.com/css?family=Raleway:900,700|Merriweather"
      rel="stylesheet"
    />
      ...
      <div class="container">
        <div class="hero-content">
          ...
          <p class="hero-description">
            Using the Wordpress Customizer you can make updates to parts of your
            website with a live preview. This makes it easy to iterate on
            changes.
          </p>
...
.button {
  ...
  box-shadow: inset 0 0 0 2px #4e3e68, 0 4px rgba(0, 70, 75, 0.2);
  border-radius: 40px;
