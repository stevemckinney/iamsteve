...
<figure>
  <img src="/images/blog/post_formats_plugin.png" width="703" height="100" />
...
<article role="article" class="link">
  ...
  <div class="entry">
    <a
      href="<?php echo esc_attr(get_post_meta($post->ID, '_format_link_url', true)); ?>"
      ><?php echo esc_attr(get_post_meta($post->ID, '_format_link_url', true));
      ?></a
    >
  </div>
