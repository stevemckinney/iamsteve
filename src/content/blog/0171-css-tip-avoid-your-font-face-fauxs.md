...
<figure>
<div class="sandbox">
  <div class="flex flex-col gap-4 p-[7.5vi]">
    <div class="text-left">
      <span class="font-extrabold font-variation-extrabold font-display text-7xl leading-7xl block">Roc Grotesk</span>
      <span class="font-ui text-ui-body block">Faux bold</span>
    </div>
    <div class="text-left">
      <span class="font-variation-extrabold font-display text-7xl leading-7xl block">Roc Grotesk</span>
      <span class="font-ui text-ui-body block">Regular bold</span>
    </div>
  </div>
</div>
