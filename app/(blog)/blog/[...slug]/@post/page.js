  ...
  return (
    <>
      ...
      <header className="col-content lg:col-container lg:col-start-2 lg:col-end-9 xl:col-start-3 xl:col-end-11 lg:row-start-1 lg:row-span-1 flex flex-col max-lg:pt-12 gap-y-4 mb-12">
        {isOldCodePost && (
          <div className="bg-cornflour-100/50 rounded-md shadow-reduced flex gap-3 leading-tight p-4 -mx-4 mb-8">
            <Icon
              icon="square-info"
              className="text-cornflour-800 flex-[0_0_auto]"
            />
            <div className="flex flex-col">
              <p className="p-0 m-0 font-body text-sm text-cornflour-800">
                <strong>
