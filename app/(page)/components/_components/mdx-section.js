...
function ComparisonImagesDemo() {
  return (
    <Disclosure
      ...
      description="Segmented control for toggling between image states. Built with accessible tab roles."
    >
      <DemoCard>
        <DemoCard.Split>
          <DemoCard.Docs>
            ...
            <PropsTable
              props={[
                ...
                },
                {
                  ...
                  type: 'string',
                  description:
                    'Optional label shown beside the segmented control',
                },
              ]}
            />
          </DemoCard.Docs>
...
function GalleryDemo() {
  return (
    <Disclosure
      title="Gallery"
      description="Grid-based image gallery for showing collections of icons, screenshots, or examples."
    >
      <DemoCard>
        <DemoCard.Split>
          <DemoCard.Docs>
...
function DemoComponentDemo() {
  return (
    <Disclosure
      title="Demo"
      description="Iframe embed for live demos and interactive examples."
    >
      <DemoCard>
        <DemoCard.Split>
          <DemoCard.Docs>
          ...
          <DemoCard>
            <DemoCard.Docs>
              <p className="text-sm text-body-80">
                ...
                after the language. Wraps both title and code in a container
                div.
              </p>
            </DemoCard.Docs>
            <DemoCard.Usage>
