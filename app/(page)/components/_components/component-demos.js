      ...
      <PropsTable
        props={[
          ...
          },
          {
            name: 'image',
            type: 'object',
            description: 'Image data for the card (not used by small variant)',
          },
          {
            name: 'className',
            type: 'string',
  ...
  return (
    ...
    >
      <Subsection title="With title">
        <Preview className="flex-col max-w-md">
          <Chat title="iMessage">
  ...
  return (
    ...
    >
      <Subsection title="Variants">
        <Preview className="gap-8 items-center">
          {['default', 'header', 'on-light', 'none'].map((variant) => (
            <div key={variant} className="flex flex-col items-center gap-2">
              <div
                className={
                  variant === 'on-light' ? 'bg-fern-800 p-3 rounded-sm' : 'p-3'
                }
              >
                <Icon
                  icon="star"
              ...
              <span className="text-2xs font-mono text-body-60">{variant}</span>
            </div>
          ))}
        </Preview>
      </Subsection>
      ...
      <PropsTable
        props={[
          ...
          },
          {
            ...
            default: "'default'",
            description: 'Colour variant controlling fill via CSS variables',
          },
          {
            name: 'className',
            type: 'string',
        ...
        props={[
          {
            name: 'href',
            type: 'string',
            description: 'Internal path (/...), anchor (#...), or external URL',
          },
          {
            name: '...props',
            type: 'HTMLAttributes',
            description: 'All standard link/anchor attributes are forwarded',
          },
        ]}
      />
    </Section>
        ...
        <Notepad>
          ...
          <Notepad.Body>
            ...
            <p className="text-body-80 text-sm">
              Great for callouts, tips, or featured content that needs to stand
              out.
            </p>
          </Notepad.Body>
        </Notepad>
    ...
    >
      <Subsection title="Illustration tokens">
        <div className="bg-surface rounded-lg shadow-placed overflow-hidden">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 p-6 border-t border-border-medium">
            {[
