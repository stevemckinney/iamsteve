...
export default function RootLayout({ children }) {
  return (
    ...
    >
       ...
       */}
      <body
        className={`antialiased overflow-x-hidden overflow-x-clip min-w-screen min-h-screen bg-[url(/images/texture.png)] bg-[172px_auto] bg-blend-multiply bg-neutral-01-150 text-fern-1100 pt-[env(safe-area-inset-top,0)]`}
      >
        <Sprite16 />
        <Sprite24 />
        <Logo />
