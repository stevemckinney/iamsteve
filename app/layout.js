...
export default function RootLayout({ children }) {
  return (
    ...
    >
       ...
       */}
      <body
        className={`overflow-x-hidden antialiased min-w-screen min-h-screen bg-neutral-01-100 text-fern-1100 grid layout gap-x-4 xl:gap-x-6 2xl:gap-x-8 max-w-[1728px] mx-auto`}
      >
        <Sprite />
        <ModeToggle />
